      ...
      <aside className="w-64 bg-white border-r border-gray-200 p-4">
        ...
        <div className="mt-6">
          <div className="text-xs text-gray-500 mb-1">
            GROUPS <span className="text-gray-400 ml-1">+add</span>
          </div>
        ...
        <div className="mt-4">
          <div className="text-xs text-gray-500 mb-1">
            FRIENDS <span className="text-gray-400 ml-1">+add</span>
          </div>
        ...
        <div className="mt-6">
          ...
          />
          <button className="w-full bg-gray-200 text-black py-1 mb-3 rounded">
            Send invite
          </button>
